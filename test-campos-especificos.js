// test-campos-especificos.js - Teste para campos específicos do frontend
const axios = require('axios');

const API_BASE_URL = 'http://localhost:3001/api';

async function testCamposEspecificos() {
  try {
    console.log('🧪 Testando campos específicos do frontend...\n');
    
    const dadosSolicitacao = {
      clinica_id: 1,
      hospital_nome: 'Clínica Teste Campos Específicos',
      hospital_codigo: 'TEST006',
      cliente_nome: 'Paciente Teste Campos Específicos',
      cliente_codigo: 'PAC006',
      sexo: 'M',
      ...
      medicamentos_antineoplasticos: 'Oxaliplatina 85mg/m² EV D1 único; Leucovorina 400mg/m² EV D1,D2 1x; Irinotecano 180mg/m² EV D1 único; 5-FU 400mg/m² EV D1 bolus + 2400mg/m² EV D1-D2 infusão contínua',
      dose_por_m2: '85mg/m²',
      dose_total: '153mg',
    ...
    if (createResponse.data.success) {
      ...
      const fs = require('fs');
      const fileName = `teste-campos-especificos-${solicitacaoId}.pdf`;
      ...
      console.log('   • Pantoprazol 40mg VO 1x/dia');
      console.log('   • Filgrastim 300mcg SC D3-D7');
